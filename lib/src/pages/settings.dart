                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          currentUser.value.name!=null?ListTile(
                            onTap: () {},
                            dense: true,
                            title: Text(
                          ...
                          currentUser.value.email!=null?ListTile(
                            onTap: () {},
                            dense: true,
                            title: Text(
                              S.of(context).email,
                          ...
                          currentUser.value.phone!=null?ListTile(
                            onTap: () {},
                            dense: true,
                            title: Text(
                              S.of(context).phone,
                          ...
                          currentUser.value.address!=null?ListTile(
                            onTap: () {},
                            dense: true,
                            title: Text(
                          ...
                          currentUser.value.bio!=null?ListTile(
                            onTap: () {},
                            dense: true,
                            title: Text(
                              S.of(context).about,
